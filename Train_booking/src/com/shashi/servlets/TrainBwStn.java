...
public class TrainBwStn extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			String fromStation = req.getParameter("fromstation").toUpperCase();
			String toStation = req.getParameter("tostation").toUpperCase();
			...
			if (trains != null && !trains.isEmpty()) {
				...
				pw.println("<div class='tab'><table><tr><th>Train Name</th><th>Train No</th>"
						+ "<th>From Stn</th><th>To Stn</th><th>Time</th><th>Seats</th><th>Fare (UAH)</th><th>Action</th></tr>");
				for (TrainBean train : trains) {
					...
					pw.println("" + "<tr><td>" + train.getTr_name() + "</td>" + "<td>" + train.getTr_no() + "</td>"
							...
							+ " UAH</td><td><a href='booktrainbyref?trainNo=" + train.getTr_no() + "&fromStn="
