	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			if (trains != null && !trains.isEmpty()) {
				...
				rd.include(req, res);
				pw.println("<div class='tab'><p1>Running Trains</p1></div>");
				pw.println("<div class='tab-view'><table class='table-view'><tr><th>Train Name</th><th>Train Number</th>"
						+ "<th>From Station</th><th>To Station</th><th>Seats Available</th><th>Fare (UAH)</th><th>Action</th></tr>");
				...
				for (TrainBean train : trains) {
					...
					pw.println("" + "<tr> " + "" + "<td><a href='viewadmin?trainNo=" + train.getTr_no() + "&fromStn="
							...
							+ train.getFare() + " UAH</td>" + "<td><a href='adminupdatetrain?trainnumber="
