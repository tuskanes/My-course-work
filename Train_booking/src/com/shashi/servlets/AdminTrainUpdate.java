		...
		try {
			...
			if (train != null) {
				...
				pw.println("<div class='tab'>" + "<table><form action='updatetrainschedule' method='post'>"
						...
						+ "<tr><td>Fare (UAH) :</td><td><input type='text' name='fare' value='" + train.getFare()
						+ "'></td></tr>"
						+ "<tr><td colspan='2' style='text-align: right;'><input type='submit' name='submit' value='Update Train Schedule' class='custom-button' ></td></tr>"
						+ "</form></table>" + "</div>");
			} else {
