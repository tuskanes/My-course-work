	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			if (trains != null && !trains.isEmpty()) {
				...
				rd.include(req, res);
				pw.println("<div class='main'><strong>Running Trains</strong></div>");
				pw.println("<div class='tab-view'><table class='table-view'><tr><th>Train Name</th><th>Train Number</th>"
						+ "<th>From Station</th><th>To Station</th><th>Time</th><th>Seats Available</th><th>Fare (UAH)</th><th>Booking</th></tr>");
				...
				for (TrainBean train : trains) {
					...
					pw.println("" + "<tr> " + "" + "<td><a href='view?trainNo=" + train.getTr_no() + "&fromStn="
							...
							+ "</td>" + "<td>" + train.getFare() + " UAH</td>" + "<td><a href='booktrainbyref?trainNo="
