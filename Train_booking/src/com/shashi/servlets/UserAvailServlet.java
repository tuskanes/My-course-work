	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException, ServletException {
		...
		try {
			...
			if (train != null) {
				...
				rd.include(req, res);
				pw.println(
						"<div class='tab'>" + "		<p1>" + "	Hello " + TrainUtil.getCurrentUserName(req)
								+ " ! Welcome to our new TrainWay Website" + "		</p1>" + "	</div>");
				pw.println("<div class='main'><p1 class='tab'>Available Seats are <p2 class=\"red\"> "
				...
				pw.println("<div class='tab'>" + "<table>" + "<tr><td class='blue'>Train Name :</td><td>"
						...
						+ train.getSeats() + "</td></tr>" + "<tr><td class='blue'>Fare (UAH) :</td><td>"
						+ train.getFare() + " UAH</td></tr>" + "</table>" + "</div>");
			} else {
